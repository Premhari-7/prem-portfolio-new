...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    const qualitySettings = {
      low: { iterations: 24, waveIterations: 1, pixelRatio: Math.min(window.devicePixelRatio, 0.5), precision: 'mediump', stepMultiplier: 1.5 },
      medium: { iterations: 40, waveIterations: 2, pixelRatio: Math.min(window.devicePixelRatio, 1), precision: 'highp', stepMultiplier: 1.2 },
      high: {
        iterations: 80,
        waveIterations: 4,
